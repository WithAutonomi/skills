...
- **2026-Sep-03 (prototype note):** added the note at the top recording that the shipped `autonomi` skill (0.1.x) runs ahead of this design in scope, custody and spend, and that the design and ADR-0002/0003/0004/0005 are revised once the prototype is proven. No other change to the body.
