...
- Vocabulary scan — only the accepted product phrases `permanence tier` and `retrieval tiers` matched.
- Lengths — passed: `SKILL.md` 253 lines; references 60, 112, 73 and 103 lines.
