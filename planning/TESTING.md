...
- The description carries the node clause at 1,019 characters; "low-latency reads" was dropped to fit. The eval loop decides whether anything else should give.
