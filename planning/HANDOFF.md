...
1. **Prepare the npm-first change.** [PR #13](https://github.com/WithAutonomi/skills/pull/13) has merged. Complete the scoped 0.1.5 checks/reviews, then ask Jim before committing/pushing or opening its PR. Current evidence is linked above.
